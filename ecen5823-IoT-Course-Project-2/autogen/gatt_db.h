...
#define gattdb_Ambient_light_Sensor           39
#define gattdb_Client_characteristic_configuration 41
#define gattdb_gesture_value                  44
#define gattdb_Client_characteristic_configuration_10 46
